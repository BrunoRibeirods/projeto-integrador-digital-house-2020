...
import kotlinx.android.synthetic.main.fragment_trending_list.view.*
...
class TrendingListFragment : Fragment() {
    override fun onCreateView(
        ...
        //trending.data has a list of Cards to display
        val trending = arguments?.getSerializable("trending") as Trending
